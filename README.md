...
A feature-first Electron framework for Vite 8+. Provides a managed runtime kernel, codegen for preload/bridge types, and configuration via `defineConfig`/`defineRuntime`/`defineWindow`.
